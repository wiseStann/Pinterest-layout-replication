...
templates['main.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<div id=\"pin__content-container-"
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"PinID") : depth0), depth0))
  ...
  return "<div class=\"feed__layout-container\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pins") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":1},"end":{"line":10,"column":10}}})) != null ? stack1 : "")
    + "</div>\n";
},"useData":true});
})();